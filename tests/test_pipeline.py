...
def critic_checkpoint_path():
    ...
    cmd = [
        sys.executable, "src/lerobot_policy_smolvla_rl/train_critic.py",
        ...
        "--model_save_name", "smoke_test",
        "--wandb_project", "pytest-smoke-test",
        "--num_workers", "0"
    ]
...
def test_recap_training(critic_checkpoint_path):
    ...
    cmd = [
        sys.executable, "src/lerobot_policy_smolvla_rl/train_recap.py",
        "--dataset_repo_id", DATASET_REPO_ID,
        "--critic_checkpoint", critic_checkpoint_path,
        "--steps", "1",
        "--batch_size", "1",
        "--num_vlm_layers", "1",
        "--critic_num_vlm_layers", "1",
        "--save_dir", save_dir,
        "--wandb_project", "pytest-smoke-test",
        "--num_workers", "0"
    ]
...
def test_visualization(critic_checkpoint_path):
    ...
    cmd = [
        sys.executable, "src/lerobot_policy_smolvla_rl/visualize_critic.py",
        "--checkpoint", critic_checkpoint_path,
        "--dataset_repo_id", DATASET_REPO_ID,
        "--episodes", str(EPISODE_INDEX),
        "--num_vlm_layers", "1",
        "--batch_size", "1",
