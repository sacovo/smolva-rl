...
def main():
    parser = argparse.ArgumentParser(description="Submit SnapFlow Distillation Training to Slurm")
    ...
    slurm_config.setdefault("partition", "h200")
    ...
    default_job_name = f"snapflow_{dataset_name}_{timestamp}"
